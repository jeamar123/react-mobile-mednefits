...
export default class Text extends Component {
  ...
  render() {
    return (
      <RNText
        {...this.props}
        allowFontScaling={(this.props.allowFontScaling) ? this.props.allowFontScaling : false}
        style={[this.props.style, {
          fontFamily: (this.state.fontFamily) ? this.state.fontFamily : Config.FONT_ALTERNATE_BOLD,
