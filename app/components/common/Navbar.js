...
export default class Navbar extends React.Component {
  ...
  renderLeft() {
    ...
    } else if (this.props.leftNav == 'back_wallet') {
      return (
        <View
          style={{
            width: 50,
    ...
    if (this.props.title && this.props.subtitle) {
      ...
      return (
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          <Image
            source={require('../../../assets/mobile-logo-white.png')}
      ...
      return (
        ...
        >
          <CustomDropdown
            ...
            dropArrowStyle={{ top: 30, right: 18 }}
            dropContainerStyle={{ top: 35, right: 5 }}
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{ backgroundColor: '#0392cf', zIndex: 10 }}>
