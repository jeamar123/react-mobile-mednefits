    ...
    return (
      <Container style={{ backgroundColor: '#efeff4' }}>
        ...
        <Content padder>
          ...
          <Buttons style={{ width: '100%' }} onPress={() => Actions.PayScan({ type: 'reset', services: this.state.services, clinicid: this.props.clinicid, clinic_data: this.props.clinic_data })}>
            Proceed
          </Buttons>
        </Content>
      </Container>
