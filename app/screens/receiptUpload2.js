    ...
    try {
      if (this.camera) {
        ...
        images = {
          ...
          filename: 'receipt' + this.props.transaction_id + '.jpg',
          filetype: 'images/jpg'
        }
          ...
          <View style={{ width: 100, justifyContent: 'center', alignItems: 'center' }}>
            {
              (this.state.images.length > 0) ?
                (
                  <TouchableOpacity
                    onPress={() => Actions.ReceiptPreview2({ transaction_id: this.props.transaction_id, shootType: this.state.shootType, receiptFiles: Object.assign({}, { images: this.state.images }, this.props.receiptFiles) })}
                    style={{
                      justifyContent: 'center',
                      alignItems: 'center',
                      marginRight: '4%'
          ...
          <View style={{ width: '33%', justifyContent: 'center', alignItems: 'center' }}>
            {
              (this.state.images.length > 0) ?
                (
                  <TouchableOpacity
                    onPress={() => Actions.ReceiptPreview({ transaction_id: this.props.transaction_id, shootType: this.state.shootType, receiptFiles: Object.assign({}, { images: this.state.images }, this.props.receiptFiles) })}
                    style={{
                      justifyContent: 'center',
                      alignItems: 'center',
                      marginRight: '4%'
